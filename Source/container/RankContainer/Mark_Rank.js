...
export default class Mark_Rank extends Component {
        ...
        fetch(url)
            ...
            .then((ResponseJson) => {
                this.setState({
                    ...
                    loading: false,
                    MarkMemberSource: ResponseJson.sort((a, b) => b.Member_Total - a.Member_Total) && ResponseJson.filter(index => index.Member_House === "Mark Zuckerberg" && index.Member_Status === "Active"),
                });
            })
            .catch(error => {
    ...
    render() {
        Top1 = this.state.MarkMemberSource.sort((a, b) =>
            b.Member_Total - a.Member_Total
        ).slice(0, 1);;

        Top2 = this.state.MarkMemberSource.sort((a, b) =>
            b.Member_Total - a.Member_Total
        ).slice(1, 2);

        Top3 = this.state.MarkMemberSource.sort((a, b) =>
            b.Member_Total - a.Member_Total
        ).slice(2, 3);
