        ...
        fetch(url)
            ...
            .then((ResponseJson) => {
                this.setState({
                    ...
                    loading: false,
                    BillMemberSource: ResponseJson.sort((a, b) => b.Member_Total - a.Member_Total) && ResponseJson.filter(index => index.Member_House === "Bill Gates" && index.Member_Status === "Active"),
                });
            })
            .catch(error => {
